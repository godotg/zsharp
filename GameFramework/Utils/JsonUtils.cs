    ...
    public static class JsonUtils
    {
        ...
        public static string ToJson(object obj)
        {
            ...
            catch (Exception exception)
            {
                ...
                throw new GameFrameworkException(
                    StringUtils.Format("Can not convert to JSON with exception '{0}'.", exception.ToString()), exception);
            }
        }
        ...
        public static T ToObject<T>(string json)
        {
            ...
            catch (Exception exception)
            {
                ...
                throw new GameFrameworkException(
                    StringUtils.Format("Can not convert to object with exception '{0}'.", exception.ToString()), exception);
            }
        }
